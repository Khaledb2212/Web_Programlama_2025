...
namespace Web_Project.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            IEmailSender emailSender, IHttpClientFactory httpClientFactory)
        {
        ...
        //            var apiResp = await client.PostAsJsonAsync("api/People/PostPerson", dto);

        //            if (!apiResp.IsSuccessStatusCode)
        //            {
        //                await _userManager.DeleteAsync(user); // rollback so you don't have "Identity only" user
        //                ModelState.AddModelError(string.Empty, "Could not create Person profile in API.");
        //                return Page();
        //            }
        ...
        //            return RedirectToAction("FinishRegistration", "Profile");
        //        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            // store extra fields so ProfileController can call API in a new request
            TempData["Firstname"] = Input.Firstname;
            TempData["Lastname"] = Input.Lastname;
            TempData["Phone"] = Input.Phone;

            // Now redirect to a controller action that will call the API using HttpClient
            return RedirectToAction("FinishRegistration", "Profile");
        }
